"""
Tag data AND derive a session key -- immediate result.

WHEN TO USE   The common case when you need both a hardware-backed tag over
              your data and a symmetric key for the session that follows.
              One request, one answer carrying both.
...
end-to-end confidentiality see hrwrequest_ek_priority_rsa2048.py.
"""
...
def main():
    ...
    # Ask the cloud for both (priority / synchronous)
    result, hrw_cloud, ek_cloud = cloud.do_device_EKpriorityrequestHRW(
