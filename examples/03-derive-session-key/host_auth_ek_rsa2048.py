...
def main():
    ...
    # Submit host auth, handing over the public key
    transactionid = cloud.do_device_hostauthEK_request_rsa(
        credentials.cloudflaretokens, iotaccesstoken, tid, hcw, hrw, public_key_pem, False)

    # Poll for the verdict and the wrapped key
    authenticationresult, claimid, encrypted_ek = cloud.do_device_hostauthEK_checkstatus_rsa(
